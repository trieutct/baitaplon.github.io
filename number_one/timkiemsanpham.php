...
<?php
   ...
   include"ham.php";
    $conn=ketnoidataba();
    $sql = "SELECT * FROM tbthemsp where tensp LIKE '%$timkiemsanpham%' OR diachi LIKE '%$timkiemsanpham%' OR gia LIKE '$timkiemsanpham'"; 
   ...
   <body>
        <div class="container">
           ...
           <div class="right">
               ...
               <table>
                   <tr>
                       <th style="height:60; background-color: lightskyblue;border:1px solid black;">Mã Hàng</th>
                   ...
                   <?php
                        ...
                        while($row = $result->fetch_assoc()) {
                            ?>
                                <tr> 
                                     <td style="width:10%;" class="td"><?php echo $row["mahang"] ?></td>
                                    <td style="width:10%;" class="td"><?php echo $row["tensp"]?></td>
                                    <td style="width:10%;" class="td"><img style="width:100px;height:80px" src="image/<?php echo $row["anh"]?>" alt=""></td>
                                    <td style="width:10%;" class="td"><?php echo $row["gia"]?></td>
                                    <td style="width:10%;" class="td"><?php echo $row["diachi"]?></td>
                                    <td style="width:10%;" class="td"><?php echo $row["mota"]?></td>
                                    <td style="width:10%;" class="td"><?php echo $row["nguyenlieu"]?></td>
                                    <td style="width:10%;" class="td"><?php echo $row["ngaytao"]?></td>
